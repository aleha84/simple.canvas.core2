    ...
    start(){
        ...
        this.addGo(new GO({
            ...
            init() {
                ...
                this.addChild(new GO({
                    position: new V2(0, -this.size.y/2 + 45 + yShift).toInt(),
                    size: new V2(this.size.x, 25),
                    init() {
