class Demo9BikeScene extends Scene {
    ...
    start(){
        ...
        this.perspectiveRight = this.addGo(new GO({
            ...
            size: new V2(this.viewport.x/2, this.viewport.y-this.roadHeight).toInt(),
            init() {
                this.type = 'expo';
                this.method = 'in';
                this.time = 80//250;
            ...
            createItem() {
                ...
                for(let i = 0; i < item.parts.length; i++){
                    ...
                    if(part.type == 'side'){
                        part.p1XChange = easing.createProps(this.time, 0, part.p1.x, this.type, this.method);
                        part.p1YChange = easing.createProps(this.time, 0, part.p1.y, this.type, this.method);
                        part.p2XChange = easing.createProps(this.time, 0, part.p2.x, this.type, this.method);
                        part.p2YChange = easing.createProps(this.time, 0, part.p2.y, this.type, this.method);
                        part.p3XChange = easing.createProps(this.time, 0, part.p3.x, this.type, this.method);
                        part.p3YChange = easing.createProps(this.time, 0, part.p3.y, this.type, this.method);
                        part.p4XChange = easing.createProps(this.time, 0, part.p4.x, this.type, this.method);
                        part.p4YChange = easing.createProps(this.time, 0, part.p4.y, this.type, this.method);
                    }
